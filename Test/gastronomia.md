...
Situado en los alrededores de la piscina, con **terraza exterior**. Ofrece **cafés, helados, tentempiés y bebidas**.

**Horarios**

* **Apertura general:** 10:30–18:30
* **Almuerzo a la carta:** 13:00–16:00

---

### Lounge Bar

Servicio de **cócteles, combinados y refrescos**. Espacio con **espectáculos**, **música en vivo** y **pista de baile**.
...
Situado en la piscina. **Solo bebidas.**
Abierto según temporada.

---

## Servicio Todo Incluido (TI) y restauración

* **Horario TI:** **07:30–23:30**
* El hotel se reserva el derecho de **modificar horarios y puntos de servicio**.
...
Disponible durante **almuerzos y cenas** en el Restaurante Buffet, con elaboración en directo de **carnes y pescados**. Incluye entrantes, ensaladas, platos principales y postres.
...
## Servicios de comidas y regímenes
...
* **Bebidas no incluidas** en la cena

### Pensión completa

* Incluye **desayuno, almuerzo y cena**
* **Bebidas no incluidas** en almuerzo y cena

---

## Bodega y vinos

* Bodega con **vinos nacionales e internacionales**
* Asesoramiento disponible para la elección de vinos

---

## Bebidas incluidas y normas generales

### Bebidas incluidas en almuerzos y cenas

* Agua
* Vino de la casa
* Caña o jarra de cerveza (Amstel y Cruzcampo Radler)
* Zumos no naturales
* Refrescos

*Nota:* la mayoría de las bebidas se sirven desde **dispensadores**, por motivos de logística y sostenibilidad.

---

## Normas de restauración

* Las bebidas y alimentos deben consumirse en los **puntos de venta**.
* No está permitido **sacar comida o bebida** de bares o restaurantes ni llevarlos a las habitaciones.
* No se permite comer o beber en **zonas comunes no habilitadas**.
* En la zona de piscinas **no se permiten vasos de cristal**.
* Se debe respetar el **código de vestimenta** indicado en la entrada del restaurante.
* No se permite acceder **descalzo** ni con **ropa de baño** a bares o restaurantes.

---

## Alergias y seguridad alimentaria
Los clientes con alergias o intolerancias (incluyendo celiaquía o intolerancia al gluten) deben informar antes de consumir cualquier alimento. El hotel dispone de opciones sin gluten en el restaurante buffet. Consultar disponibilidad con el personal del restaurante.
